...
async def analyze_stock_trending(
    ...
    try:
        ...
        # System prompt
        system_message = f"""You are ToponeLogic Assistant, a professional financial market analyst with expertise in stock market analysis.
...
async def analyze_stock_trending_stream(
    ...
    try:
        ...
        # System prompt
        system_message = f"""You are ToponeLogic AI, a professional financial market analyst with expertise in stock market analysis.
...
You are ToponeLogic Assistant, an expert in the stock market analyst specializing in heatmap visualization and market trends analysis multi-language.
...
async def analyze_stock_heatmap_stream(
    ...
    try:
        ...
        # Create heatmap analysis prompt
        system_prompt = f"""You are ToponeLogic Assistant an expert in the stock market analyst specializing in heatmap visualization and market trends analysis multi-language.
