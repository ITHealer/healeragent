...
# Central package for all atomic trading tools.

# Usage:
#     from src.tools import get_registry, initialize_registry
...
Usage:
    from src.agents.tools import get_registry, initialize_registry
