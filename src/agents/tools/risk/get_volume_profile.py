...
#         self,
#         symbol: str,
#         timeframe: str = "1M",  # Added timeframe to match schema
#         lookback_days: int = 60,
#         num_bins: int = 10
#     ) -> ToolOutput:
#         """
...
#         Args:
#             symbol: Stock ticker
#             timeframe: Timeframe string (1W, 1M, 3M, 6M) - Overrides lookback_days if provided
#             lookback_days: Manual override for days (fallback)
#             num_bins: Number of price bins for profile
            
#         ENHANCED: Automatically maps timeframe to days and handles insufficient data
#         """
#         symbol_upper = symbol.upper()
        
#         # 1. Map timeframe to lookback_days logic
#         timeframe_map = {
#             "1W": 7,
#             "1M": 30,
#             "3M": 90,
...
#         # If timeframe is valid, it takes precedence
...
#         # Validate and constrain parameters
#         lookback_days = max(7, min(365, lookback_days)) # Adjusted min/max logic
#         num_bins = max(5, min(50, num_bins))
        
#         self.logger.info(
#             f"[getVolumeProfile] Executing for symbol={symbol_upper}, "
#             f"timeframe={timeframe}, lookback_days={lookback_days}, num_bins={num_bins}"
#         )
...
#         # Test 1: Valid symbol with default params
#         print("\n📊 Test 1: Valid symbol (TSLA) with timeframe='1M'")
#         print("-" * 40)
...
#         if result.is_success():
#             print("✅ SUCCESS")
#             # print(json.dumps(result.data, indent=2, default=str)) # Uncomment to see full data
#             print(f"POC: {result.data.get('poc')}")
#         else:
#             print(f"❌ ERROR: {result.error}")
        
#         # Test 2: Custom parameters
#         print("\n📊 Test 2: NVDA with custom timeframe '3M'")
#         print("-" * 40)
#         result = await tool.safe_execute(
#             symbol="NVDA",
#             timeframe="3M",
...
# File: src/agents/tools/technical/get_volume_profile.py

"""
GetVolumeProfileTool - FIXED VERSION

Changes:
✅ Added volume_profile, volume_trend, avg_daily_volume (REQUIRED)
✅ Enhanced _format_volume_profile() method
✅ Calculate missing fields from handler data
"""
